# La fée aux roses. Musique de F. Halévy (3TDUkEVUgc6F)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/3TDUkEVUgc6F.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/3TDUkEVUgc6F.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/3TDUkEVUgc6F.csv){ .md-button }
...
!!! note "metadata"
    - class: Manifestation
    - label: La fée aux roses. Musique de F. Halévy
    - id: 3TDUkEVUgc6F
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/3TDUkEVUgc6F.json";
    </script>
...
???+ abstract "based on"
    - [La fée aux roses. Musique de F. Halévy](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/3TDUkEVUgc6F)
