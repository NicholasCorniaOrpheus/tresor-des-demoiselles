# La fée aux roses. Paroles de Mrs Scribe et de St Georges. Musique de F. Halévy (kLWLt9hwDNKA)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/kLWLt9hwDNKA.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/kLWLt9hwDNKA.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/kLWLt9hwDNKA.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-BV14-3018){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-BV14-3018/BV14-3018_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: La fée aux roses. Paroles de Mrs Scribe et de St Georges. Musique de F. Halévy
    - id: kLWLt9hwDNKA
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/kLWLt9hwDNKA.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [88236](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=88236)
        * publication date: 1850
...
???+ abstract "title"
    - La fée aux roses : paroles de Mrs Scribe et de St Georges ; musique de F. Halévy
...
???+ abstract "based on"
    - [la fée aux roses](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/eauevD6EbcxD)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-BV14-3018/",
        images: ["BV14-3018_001.jpg", "BV14-3018_002.jpg", "BV14-3018_003.jpg"],
        iiif: ""
      };
    </script>
