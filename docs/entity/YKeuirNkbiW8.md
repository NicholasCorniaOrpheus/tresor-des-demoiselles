# Benjamin Bilse (YKeuirNkbiW8)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/YKeuirNkbiW8.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/YKeuirNkbiW8.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/YKeuirNkbiW8.csv){ .md-button }


<img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/Benjamin_Bilse.jpg?utm_source=www.wikidata.org&utm_campaign=imageinfo&utm_content=original" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Agent
    - label: Benjamin Bilse
    - id: YKeuirNkbiW8
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/YKeuirNkbiW8.json";
    </script>
...
???+ abstract "identifier"
    - [Q457806](http://www.wikidata.org/entity/Q457806)
