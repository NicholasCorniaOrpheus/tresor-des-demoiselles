# Souvenir de Galluis. Mélodie variée (8Kkx7abwhpEx)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/8Kkx7abwhpEx.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/8Kkx7abwhpEx.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/8Kkx7abwhpEx.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-BV14-2029_1855-2){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-BV14-2029_1855-2/BV14-2029_1855-2-1_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Souvenir de Galluis. Mélodie variée
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/8Kkx7abwhpEx.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [88855](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=88855)
...
???+ abstract "title"
    - Souvenir de Galluis : mélodie variée : Extrait de L' Oasis de l' étude / par A. Scard
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-BV14-2029_1855-2/",
        images: ["BV14-2029_1855-2_001.jpg", "BV14-2029_1855-2_002.jpg", "BV14-2029_1855-2_003.jpg"],
        iiif: ""
      };
    </script>
