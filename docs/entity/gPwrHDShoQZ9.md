# La maison isolée. Cantilène. Paroles et musique d'Eugène Talbot (gPwrHDShoQZ9)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/gPwrHDShoQZ9.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/gPwrHDShoQZ9.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/gPwrHDShoQZ9.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_24){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_24/CR-02772_24_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: La maison isolée. Cantilène. Paroles et musique d'Eugène Talbot
    - id: gPwrHDShoQZ9
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/gPwrHDShoQZ9.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [61734](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61734)
...
???+ abstract "title"
    - La maison isolée : cantilène / paroles et musique d'Eugène Talbot
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_24/",
        images: ["CR-02772_24_001.jpg"],
        iiif: ""
      };
    </script>
