# Juliette. Redowa. Par Maurant (JMs7RV45f7Nm)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/JMs7RV45f7Nm.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/JMs7RV45f7Nm.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/JMs7RV45f7Nm.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_19){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_19/CR-02772_19_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Juliette. Redowa. Par Maurant
    - id: JMs7RV45f7Nm
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/JMs7RV45f7Nm.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [Nicolau Manent](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/SeXwxsETv2Gv)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61729](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61729)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_19/",
        images: ["CR-02772_19_001.jpg", "CR-02772_19_002.jpg"],
        iiif: ""
      };
    </script>
