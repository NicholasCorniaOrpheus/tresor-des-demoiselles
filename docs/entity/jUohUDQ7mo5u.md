# Abonnés du Journal des Demoiselles (jUohUDQ7mo5u)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/jUohUDQ7mo5u.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/jUohUDQ7mo5u.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/jUohUDQ7mo5u.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Abonnés du Journal des Demoiselles
    - aliases: Subscribers of the Journal des Demoiselles
    - id: jUohUDQ7mo5u
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/jUohUDQ7mo5u.json";
    </script>
