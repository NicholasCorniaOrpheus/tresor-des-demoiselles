# Journal des demoiselles (1841) (CCYeABXF9uN3)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/CCYeABXF9uN3.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/CCYeABXF9uN3.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/CCYeABXF9uN3.csv){ .md-button }
...
!!! note "metadata"
    - class: Manifestation
    - label: Journal des demoiselles (1841)
    - id: CCYeABXF9uN3
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/CCYeABXF9uN3.json";
    </script>
...
???+ abstract "part of"
    - [Journal des demoiselles](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/NS7S3TJjbHvU)
        * volume: 9
        * publication date: 1841-01-01

???+ abstract "has version"
    - 
        * permalink: [ONB_alma21287762010003338](https://search.onb.ac.at/permalink/f/sb7jht/ONB_alma21287762010003338)
        * holding institution: [Austrian National Library](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/6TWgDcxqkKDN)
        * publication date: 1841-01-01
        * external source: [10A4EB6F](https://viewer.onb.ac.at/10A4EB6F/)
        * IIIF manifest: [10A4EB6F](https://api.onb.ac.at/iiif/presentation/v3/manifest/10A4EB6F)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "/",
        images: [],
        iiif: "['https://api.onb.ac.at/iiif/presentation/v3/manifest/10A4EB6F']"
      };
    </script>
