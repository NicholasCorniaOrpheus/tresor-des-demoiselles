# Ernesto Nicolini (iSimXAKtZnp4)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/iSimXAKtZnp4.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/iSimXAKtZnp4.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/iSimXAKtZnp4.csv){ .md-button }


<img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Ernesto_Nicolini_by_August_Weger.jpg?utm_source=www.wikidata.org&utm_campaign=imageinfo&utm_content=original" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Agent
    - label: Ernesto Nicolini
    - id: iSimXAKtZnp4
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/iSimXAKtZnp4.json";
    </script>
...
???+ abstract "identifier"
    - [Q3083329](http://www.wikidata.org/entity/Q3083329)
