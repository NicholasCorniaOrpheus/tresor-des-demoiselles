# notated music (PoUD3gvUcVyr)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/PoUD3gvUcVyr.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/PoUD3gvUcVyr.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/PoUD3gvUcVyr.csv){ .md-button }
...
!!! note "metadata"
    - class: Manifestation
    - description: handwritten or printed form of musical notation that uses musical symbols to indicate the pitches, rhythms, or chords of a song or instrumental musical piece
    - aliases: sheet music; score; partiture
    - label: notated music
    - id: PoUD3gvUcVyr
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/PoUD3gvUcVyr.json";
    </script>
...
???+ abstract "identifier"
    - 
        * http: //www.wikidata.org/entity/Q187947
