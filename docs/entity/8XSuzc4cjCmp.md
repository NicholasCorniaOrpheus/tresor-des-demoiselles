# Carl Maria von Weber (8XSuzc4cjCmp)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/8XSuzc4cjCmp.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/8XSuzc4cjCmp.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/8XSuzc4cjCmp.csv){ .md-button }


<img src="https://upload.wikimedia.org/wikipedia/commons/4/42/Caroline_Bardua_-_Bildnis_des_Komponisten_Carl_Maria_von_Weber.jpg?utm_source=www.wikidata.org&utm_campaign=imageinfo&utm_content=original" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Agent
    - label: Carl Maria von Weber
    - id: 8XSuzc4cjCmp
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/8XSuzc4cjCmp.json";
    </script>
...
???+ abstract "identifier"
    - [Q154812](http://www.wikidata.org/entity/Q154812)
