# Delia. Polka-mazurka. Par Albin de Leïris (oCXudSphqf9d)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/oCXudSphqf9d.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/oCXudSphqf9d.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/oCXudSphqf9d.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_22){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_22/CR-02772_22_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Delia. Polka-mazurka. Par Albin de Leïris
    - id: oCXudSphqf9d
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/oCXudSphqf9d.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [Albin de Leiris](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/d3ATGHtkH8gd)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61732](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61732)
...
???+ abstract "title"
    - Delia : polka-mazurka / par Albin de Leïris
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_22/",
        images: ["CR-02772_22_001.jpg"],
        iiif: ""
      };
    </script>
