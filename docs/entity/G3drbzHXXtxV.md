...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/G3drbzHXXtxV.json";
    </script>
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "/",
        images: [],
        iiif: "['https://api.digitale-sammlungen.de/iiif/presentation/v2/bsb11308545/manifest']"
      };
    </script>
