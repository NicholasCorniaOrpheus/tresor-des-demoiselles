# Les guides de Murat. Quadrille brillant (2v8RvsAdQppS)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/2v8RvsAdQppS.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/2v8RvsAdQppS.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/2v8RvsAdQppS.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCA-12977376){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCA-12977376/RCA-12977376_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Les guides de Murat. Quadrille brillant
    - id: 2v8RvsAdQppS
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/2v8RvsAdQppS.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [c:lvd:12977376](https://anet.be/record/ap/opacap/c:lvd:12977376)
...
???+ abstract "title"
    - Les guides de Murat : quadrille brillant
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCA-12977376/",
        images: ["RCA-12977376_001.jpg", "RCA-12977376_002.jpg", "RCA-12977376_003.jpg", "RCA-12977376_004.jpg"],
        iiif: ""
      };
    </script>
