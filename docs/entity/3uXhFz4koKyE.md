# Le carnaval au pensionnat. Quadrille. J. B. Tolbecque (3uXhFz4koKyE)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/3uXhFz4koKyE.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/3uXhFz4koKyE.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/3uXhFz4koKyE.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_23){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_23/CR-02772_23_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Le carnaval au pensionnat. Quadrille. J. B. Tolbecque
    - id: 3uXhFz4koKyE
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/3uXhFz4koKyE.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [Jean-Baptiste-Joseph Tolbecque](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/BYP8tqy6dgqh)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61733](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61733)
...
???+ abstract "title"
    - Le carnaval au pensionnat : quadrille / J. B. Tolbecque
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_23/",
        images: ["CR-02772_23_001.jpg", "CR-02772_23_002.jpg"],
        iiif: ""
      };
    </script>
