# Albin de Leiris (d3ATGHtkH8gd)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/d3ATGHtkH8gd.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/d3ATGHtkH8gd.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/d3ATGHtkH8gd.csv){ .md-button }
...
!!! note "metadata"
    - class: Agent
    - label: Albin de Leiris
    - aliases: Albin de Leïris
    - id: d3ATGHtkH8gd
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/d3ATGHtkH8gd.json";
    </script>
