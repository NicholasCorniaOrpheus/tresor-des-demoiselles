# Le pré aux clercs. Ouverture arrangée pour le piano avec acct. de violon (FgGSNR8FMujM)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/FgGSNR8FMujM.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/FgGSNR8FMujM.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/FgGSNR8FMujM.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCA-15416833){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCA-15416833/RCA-15416833_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Le pré aux clercs. Ouverture arrangée pour le piano avec acct. de violon
    - description: Only piano part survived
    - id: FgGSNR8FMujM
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/FgGSNR8FMujM.json";
    </script>
...
???+ abstract "instance of"
    ...
    - [incomplete](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/n4RMfkLzdSss)

???+ abstract "part of"
    - [Journal des dames et des demoiselles. Guide complet de tous les travaux de dames](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/5vMfYTL9wGVi)

???+ abstract "contributor"
    - [Victor Rifaut](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/YEJrXGtRWrUF)
        * role: [arranger](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/cZsa9QkDZfZY)

???+ abstract "has version"
    - 
        * permalink: [c:lvd:15416833](https://go.wander.be/record/opacap/c:lvd:15416833)
...
???+ abstract "title"
    - Le pré aux clercs : ouverture arrangée pour le piano avec acct. de violon (ad libitum)

???+ abstract "instrumentation"
    - [violin](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/Un5sANwGQqnd)
        * quantity: 1
    - [piano](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/HVUSjYYisyE8)
        * quantity: 1

???+ abstract "based on"
    - [Le pré aux clercs](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/JEJVgyKnT7Q9)

???+ abstract "form of creative work"
    - [overture](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/FJbVhQcQoVGQ)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCA-15416833/",
        images: ["RCA-15416833_001.jpg", "RCA-15416833_002.jpg", "RCA-15416833_003.jpg", "RCA-15416833_004.jpg", "RCA-15416833_005.jpg", "RCA-15416833_006.jpg", "RCA-15416833_007.jpg", "RCA-15416833_008.jpg"],
        iiif: ""
      };
    </script>
