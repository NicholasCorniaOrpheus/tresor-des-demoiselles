# Biblioteca Civica di Riva del Garda (imcKCzyxkTwE)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/imcKCzyxkTwE.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/imcKCzyxkTwE.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/imcKCzyxkTwE.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Biblioteca Civica di Riva del Garda
    - id: imcKCzyxkTwE
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/imcKCzyxkTwE.json";
    </script>
...
???+ abstract "location"
    - [7ghKvwoUDWGX]](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/7ghKvwoUDWGX])

???+ abstract "official website"
    - [biblioteca](http://www.comune.rivadelgarda.tn.it/biblioteca)

???+ abstract "identifier"
    - [Q112944579](http://www.wikidata.org/entity/Q112944579)
