# Maïa. Polka mazurka. Par A. Morin (Pwixv9i4zdSe)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/Pwixv9i4zdSe.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/Pwixv9i4zdSe.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/Pwixv9i4zdSe.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_18){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_18/CR-02772_18_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Maïa. Polka mazurka. Par A. Morin
    - id: Pwixv9i4zdSe
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/Pwixv9i4zdSe.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [A. Morin](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/HVwFKDmktcqF)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61728](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61728)
...
???+ abstract "title"
    - Maïa : polka mazurka / par A. Morin
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_18/",
        images: ["CR-02772_18_001.jpg"],
        iiif: ""
      };
    </script>
