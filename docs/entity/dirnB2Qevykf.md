# Zabella. Schottisch (dirnB2Qevykf)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/dirnB2Qevykf.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/dirnB2Qevykf.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/dirnB2Qevykf.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCA-12977313){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCA-12977313/RCA-12977313_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Zabella. Schottisch
    - id: dirnB2Qevykf
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/dirnB2Qevykf.json";
    </script>
...
???+ abstract "contributor"
    - [Ed. Billard](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/eio68muLsyCF)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [c:lvd:12977313](https://anet.be/record/ap/opacap/c:lvd:12977313)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCA-12977313/",
        images: ["RCA-12977313_001.jpg", "RCA-12977313_002.jpg", "RCA-12977313_003.jpg"],
        iiif: ""
      };
    </script>
