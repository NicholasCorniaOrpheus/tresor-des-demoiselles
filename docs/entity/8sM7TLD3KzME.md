# Léo Delibes (8sM7TLD3KzME)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/8sM7TLD3KzME.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/8sM7TLD3KzME.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/8sM7TLD3KzME.csv){ .md-button }
...
!!! note "metadata"
    - class: Agent
    - label: Léo Delibes
    - aliases: Clément Philibert Léo Delibes
    - id: 8sM7TLD3KzME
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/8sM7TLD3KzME.json";
    </script>
...
???+ abstract "identifier"
    - [Q207951](http://www.wikidata.org/entity/Q207951)
