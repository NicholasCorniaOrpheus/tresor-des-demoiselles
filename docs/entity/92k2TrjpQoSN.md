# Prussen Schottisch (92k2TrjpQoSN)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/92k2TrjpQoSN.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/92k2TrjpQoSN.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/92k2TrjpQoSN.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_26){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_26/CR-02772_26_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Prussen Schottisch
    - id: 92k2TrjpQoSN
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/92k2TrjpQoSN.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [Eugène Bousquet](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/MzKoxNkE4So3)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61736](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61736)
...
???+ abstract "title"
    - Prussen Schottisch Eugène Bousquet
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_26/",
        images: ["CR-02772_26_001.jpg", "CR-02772_26_002.jpg"],
        iiif: ""
      };
    </script>
