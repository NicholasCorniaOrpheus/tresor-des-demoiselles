# Quadrille sur l'opéra Le prophète (YchLbp5wxwMv)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/YchLbp5wxwMv.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/YchLbp5wxwMv.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/YchLbp5wxwMv.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCA-12977282){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCA-12977282/RCA-12977282_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Quadrille sur l'opéra Le prophète
    - id: YchLbp5wxwMv
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/YchLbp5wxwMv.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [c:lvd:12977282](https://go.wander.be/record/opacap/c:lvd:12977282)
...
???+ abstract "title"
    - Quadrille sur l'opéra Le prophète
...
???+ abstract "based on"
    - [Le prophète](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/RNwEeP5MdCkK)
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCA-12977282/",
        images: ["RCA-12977282_001.jpg", "RCA-12977282_002.jpg", "RCA-12977282_003.jpg", "RCA-12977282_004.jpg"],
        iiif: ""
      };
    </script>
