# Pavane. Musique de Mlle H. Wild (HcCqx9kcHttd)
...
<script>
  ...
  window.entityGraphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/HcCqx9kcHttd.json";
</script>
## Statements
...
???+ abstract "has version"
    - 
        * permalink: [89102](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=89102)
