# Fanny. polka pour le piano. Par A. Daguin (JAMwnD46n8SM)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/JAMwnD46n8SM.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/JAMwnD46n8SM.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/JAMwnD46n8SM.csv){ .md-button }
[:material-github: assets folder](https://github.com/NicholasCorniaOrpheus/tresor-des-demoiselles/tree/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_21){ .md-button }


<img src="https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/tresor-des-demoiselles/assets/RCB-CR-02772_21/CR-02772_21_001.jpg" width="200" height="300" style="float:left; margin-right:20px; border: 1px solid #eee;">
!!! note "metadata"
    - class: Manifestation
    - label: Fanny. polka pour le piano. Par A. Daguin
    - id: JAMwnD46n8SM
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/JAMwnD46n8SM.json";
    </script>
...
???+ abstract "contributor"
    ...
    - [A. Daguin](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/g6GkTxFENv6x)
        * role: [composer](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/9Y8pKvFMJST5)

???+ abstract "has version"
    - 
        * permalink: [61731](https://catalog.b-bc.org/cgi-bin/koha/opac-detail.pl?biblionumber=61731)
...
???+ abstract "title"
    - Fanny : polka pour le piano / par A. Daguin
...
??? abstract "Digitised images"
    ...
    <script>
      ...
      window.kbGraphConfig.assets = {
        ...
        local_path: "assets/RCB-CR-02772_21/",
        images: ["CR-02772_21_001.jpg", "CR-02772_21_002.jpg"],
        iiif: ""
      };
    </script>
