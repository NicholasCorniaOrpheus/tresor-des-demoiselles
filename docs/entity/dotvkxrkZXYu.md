# Antoine Rocheblave (dotvkxrkZXYu)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/dotvkxrkZXYu.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/dotvkxrkZXYu.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/dotvkxrkZXYu.csv){ .md-button }
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/dotvkxrkZXYu.json";
    </script>
...
???+ abstract "date of birth"
    - 1829
        * reference URL: [Rocheblave.html](https://www.artlyrique.fr/personnages/Rocheblave.html)
...
???+ abstract "identifier"
    - [Q141495527](http://www.wikidata.org/entity/Q141495527)

???+ abstract "occupation"
    - [arranger](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/cZsa9QkDZfZY)
