# Un Loi Somptuaire. opérette en deux actes (NwbDdEzfpcoh)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/NwbDdEzfpcoh.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/NwbDdEzfpcoh.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/NwbDdEzfpcoh.csv){ .md-button }
...
!!! note "metadata"
    - class: Manifestation
    - label: Un Loi Somptuaire. opérette en deux actes
    - id: NwbDdEzfpcoh
...
<script>
  ...
  window.entityGraphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/NwbDdEzfpcoh.json";
</script>
## Statements
...
???+ abstract "contributor"
    - [Paul Dubourg](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/4Z9bCRmwDbS7)
        * role: [librettist](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/Mgp8YUwRv3Jz)
    - [Victor Massé](https://nicholascorniaorpheus.github.io/tresor-des-demoiselles/entity/VKzHPzJxYHNi)
...
???+ abstract "title"
    - Un Loi Somptuaire. opérette en deux actes
