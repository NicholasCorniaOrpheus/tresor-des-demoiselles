# Le procès. Opérette en un acte (RvidFN62EdQh)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/RvidFN62EdQh.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/RvidFN62EdQh.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/RvidFN62EdQh.csv){ .md-button }
...
!!! note "metadata"
    - class: Manifestation
    - label: Le procès. Opérette en un acte
    - id: RvidFN62EdQh
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/RvidFN62EdQh.json";
    </script>
...
???+ abstract "has version"
    - 
        * permalink: [alma991012401879706186](https://strutture-provincia.primo.exlibrisgroup.com/permalink/39SBT_INST/116i12g/alma991012401879706186)
        ...
        * note: The libretto is available on pag. 205-208 of the associated periodical.

???+ abstract "title"
    - Le procès : opérette en un acte paroles de M.me Adam-Boisgontier ; musique de Albert Grisar.
