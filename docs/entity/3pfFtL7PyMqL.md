# Abonées du Journal des Dames et Demoiselles (3pfFtL7PyMqL)


[JSON :material-code-json:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/json/3pfFtL7PyMqL.json){ .md-button }
[RDF :material-vector-link:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/rdf/3pfFtL7PyMqL.ttl){ .md-button }
[CSV :material-table:](https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/csv/3pfFtL7PyMqL.csv){ .md-button }
...
!!! note "metadata"
    - class: Organisation
    - label: Abonées du Journal des Dames et Demoiselles
    - aliases: Subscribers of the Journal des Dames et Demoiselles
    - id: 3pfFtL7PyMqL
...
??? abstract "Explore relationships"
    ...
    <script>
      ...
      window.kbGraphConfig.graphUrl = "https://raw.githubusercontent.com/NicholasCorniaOrpheus/tresor-des-demoiselles/main/data/graph/3pfFtL7PyMqL.json";
    </script>
